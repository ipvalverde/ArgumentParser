...
namespace IPValverde.ArgumentParser
{
    public static class Parser
    {
            ...
            where T : class
        {
            ...
            for (int i = 0; i < arguments.Length; i++)
            {
                ...
                PropertyInfoArgumentAttribute propInfoArgumentAttribute;
                if (propertyArgumentsDictionary.TryGetValue(argument, out propInfoArgumentAttribute))
                {
